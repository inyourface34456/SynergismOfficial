...
const buildAchievementReq: (() => boolean)[] = [
  ...
  () => (player.secondOwnedCoin >= 500 && player.achievements[11] < 0.5),
  ...
  () => (player.thirdOwnedCoin >= 333 && player.achievements[18] < 0.5),
  ...
  () => (player.fourthOwnedCoin >= 250 && player.achievements[25] < 0.5),
  ...
  () => (player.fifthOwnedCoin >= 200 && player.achievements[32] < 0.5),
